...
for variable in is_specialized digits digits10 max_digits10 is_signed is_integer is_exact radix min_exponent min_exponent10 max_exponent max_exponent10 \
                has_infinity has_quiet_NaN has_signaling_NaN has_denorm has_denorm_loss is_iec559 is_bounded is_modulo traps tinyness_before round_style
do
...
static_assert(std::numeric_limits<si8>::is_modulo == std::numeric_limits<std::underlying_type_t<si8>>::is_modulo);
...
static_assert(std::numeric_limits<si16>::is_modulo == std::numeric_limits<std::underlying_type_t<si16>>::is_modulo);
...
static_assert(std::numeric_limits<si32>::is_modulo == std::numeric_limits<std::underlying_type_t<si32>>::is_modulo);
...
static_assert(std::numeric_limits<si64>::is_modulo == std::numeric_limits<std::underlying_type_t<si64>>::is_modulo);
...
static_assert(std::numeric_limits<ui8>::is_modulo == std::numeric_limits<std::underlying_type_t<ui8>>::is_modulo);
...
static_assert(std::numeric_limits<ui16>::is_modulo == std::numeric_limits<std::underlying_type_t<ui16>>::is_modulo);
...
static_assert(std::numeric_limits<ui32>::is_modulo == std::numeric_limits<std::underlying_type_t<ui32>>::is_modulo);
...
static_assert(std::numeric_limits<ui64>::is_modulo == std::numeric_limits<std::underlying_type_t<ui64>>::is_modulo);
